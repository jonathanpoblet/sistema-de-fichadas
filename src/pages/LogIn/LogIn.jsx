    ...
    <main className='login'>
      <section className='login-section'>
        ...
        <p className='login-section-text'>
          TODOS LOS COLABORADORES TIENEN ACCESO. En el <strong>primer ingreso</strong>, ingresá como usuario y clave tu <strong>N° de DNI.</strong> <br /> Si usted es proveedor, debe acceder a{' '}
          <a style={{ textDecoration: 'none' }} href='http://grupotaraborelli.com/proveedores/login.html'>
            Portal Proveedores
          </a>{' '}
          <br />
          Cualquier inconveniente con el acceso comunicarse con{' '}
          <a style={{ textDecoration: 'none' }} href='mailto:soporte@grupotaraborelli.com'>
            soporte@grupotaraborelli.com
          </a>{' '}
          .{' '}
        </p>
      </section>
